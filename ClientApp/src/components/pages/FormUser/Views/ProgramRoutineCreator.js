                    ...
                    <ExpansionPanelDetails>
                        <Grid container style={containerGridstyle}>
                            ...
                            <Grid item xs={12} style={GridItemStyle}>
                                ...
                                <Button style={{ zIndex: "2", marginTop: "10px", fontSize: "18px", display: 'flex', alignSelf: 'center', minWidth: 0, width: "35px", height: "35px", marginBottom: '10px', borderRadius: "98px", backgroundColor: "white", border: '1px solid', cursor: "default", pointerEvents: "none", left: 10 }} className="backBtn">
                                    3
                                </Button>

                                <Button style={{ zIndex: "2", marginTop: "10px", fontSize: "18px", display: 'flex', alignSelf: 'center', minWidth: 0, width: "35px", height: "35px", marginBottom: '10px', borderRadius: "98px", backgroundColor: "white", border: '1px solid', cursor: "default", pointerEvents: "none", left: 80 }} className="backBtn">
                                    2
                                </Button>
                                        ...
                                        <Grid item xs={12} style={{ display: index + 1 > S_CasesXYfotGreenRectPRC.length ? 'none' : 'flex', flexDirection: 'column', padding: 8, backgroundColor: "#f5f5f5", marginBottom: "4px" }}>
                                            <>
                                                ...
                                                <div onClick={(e) => showOnFieldsClickAllRect(index, G_casedata, e)} style={{ display: 'flex', flexDirection: 'row', backgroundColor: "#f5f5f5" }}>
                                                    ...
                                                    <Button style={{ zIndex: "2", marginTop: "10px", fontSize: "18px", display: 'flex', alignSelf: 'center', minWidth: 0, width: "35px", height: "35px", marginBottom: '10px', borderRadius: "98px", backgroundColor: "white", border: '1px solid', cursor: "default", pointerEvents: "none", left: 30 }} className="backBtn">
                                                        3
                                                    </Button>
                                                    ...
                                                    <Button style={{ zIndex: "2", marginTop: "10px", fontSize: "18px", display: 'flex', alignSelf: 'center', minWidth: 0, width: "35px", height: "35px", marginBottom: '10px', borderRadius: "98px", backgroundColor: "white", border: '1px solid', cursor: "default", pointerEvents: "none", left: 125 }} className="backBtn">
                                                        1
                                                    </Button>

                                                    <Button style={{ zIndex: "2", marginTop: "10px", fontSize: "18px", display: 'flex', alignSelf: 'center', minWidth: 0, width: "35px", height: "35px", marginBottom: '10px', borderRadius: "98px", backgroundColor: "white", border: '1px solid', cursor: "default", pointerEvents: "none", left: 190 }} className="backBtn">
                                                        <TextField
                                                            value={"#" + (index + 1)}
                                                            InputProps={{
                                                                readOnly: true,
                                                    ...
                                                    <Checkbox
                                                        ...
                                                        style={{ width: "18px", height: "18px", top: "15px", left: "210px" }} {...label}
                                                    />
                                                </div>
                                                ...
                                                <div style={PRC_DivCase_Style}>
                                                    <div style={{ display: 'flex', flexDirection: 'row', padding: "1px", marginBottom: "1px", marginTop: "6px", height: "30px", }}>
                                                        ...
                                                        <div>
                                                            ...
                                                            <TextField style={{ height: "27px", marginTop: "4px", left: "160px", width: "60px", }}
