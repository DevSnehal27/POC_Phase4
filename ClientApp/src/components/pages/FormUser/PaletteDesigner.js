...
class PaletteDesignerPage extends Component {
  constructor(props) {
    ...
    this.set_2ndPrePos_X = 0;
    this.set_2ndPrePos_Y = 0;
    this.set_2ndPrePos_Z = 0;

    this.set_3rdPrePos_X = 0;
    this.set_3rdPrePos_Y = 0;
    this.set_3rdPrePos_Z = 0;
  ...
  handleChangepanel = (name) => (event) => {
    ...
    if (this.state.panelname == "panel4" || this.state.panelname == "panel5") {
      ...
      console.log("this.state.CasesXYfotGreenRectPRC.length::", this.state.CasesXYfotGreenRectPRC.length);
      if (this.firstcase_pal1 == "Upper Left Corner") {
        // const newPosArray = [...this.state.CasesXYfotGreenRectPRC].sort((a, b) => (a.y - b.y))       
        const newPosArray = [...this.state.CasesXYfotGreenRectPRC].sort((a, b) => {
          if (a.y == b.y) {
      ...
      const tempArr = this.casedata.map((item) => {
        ...
        if (item.cases === "Case " + value) {
          if ((name === "pre_Pos_X")) {
            ...
            console.log("Inside pre_Pos_2X this.offset_2ndPrePos_X = ", this.offset_2ndPrePos_X);
            return {
              ...item,
            ...
            console.log("Inside pre_Pos_3X this.offset_3rdPrePos_X = ", this.offset_3rdPrePos_X);
            ...
            console.log("Inside pre_Pos_3Y this.offset_3rdPrePos_Y = ", this.offset_3rdPrePos_Y);
            return {
              ...item,
                ...
                <Paper style={{ position: "relative", width: threedwidth, height: threedheight }}>
                  ...
                  {this.state.panelname == "" || this.state.panelname == "panel2"
                    ...
                    <div >
                      ...
                      <img src={LogoPaster} style={{ width: "640px", height: "280px", marginTop: "34px", marginLeft: "65px" }} className='videoTag' alt="" />
                    </div>
                    :
                    ""
                  }
