  ...
  render() {
    ...
    return (
      <div className="parent" style={{ width: "1366px", height: "500px" }}>
        ...
        <div>
          <nav className="navbar navbar-expand-md navbar-light bg-light" style={{display:"flex",flexDirection:"row"}}>
            ...
            {/* <Link to="/help_manual" className="navbar-brand" disabled={true}>
              <div style={{ cursor: "default", }} disabled={true}>{t("Help Manual")}</div>
</Link> */}
                          ...
                          <TableBody className={classes.tableBody}>
                            {this.state.palletRows.map((row) => {
                              ...
                              if (this.tablePalletNames.length == 0) {
                                ...
                                if (this.tablePalletNames.indexOf(row.name) > -1) {
                                  console.log("Table case name already exists");
                                } else {
                                  this.tablePalletNames.push(row.name);
                                  if (this.toggle == true) {
